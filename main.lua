...
function Material:Load(Config)
	...
	CloseButton.MouseButton1Down:Connect(function()
		...
		TweenService:Create(CloseButton, TweenInfo.new(0.15), {ImageColor3 = Open and Theme.Close or Theme.Maximise}):Play()
		TweenService:Create(CloseShadow, TweenInfo.new(0.15), {ImageColor3 = Open and Theme.CloseAccent or Theme.MaximiseAccent}):Play()
		if Open then
			wait(0.15)
